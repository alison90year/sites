  ...
  chainWebpack: (config)=>{
    ...
    config.module
     ...
     config.resolve.alias
      ...
      .set('@publicImg',resolve(`./public/assets/imgs/${SITE}`))
       .set('@baseImg',resolve(`./public/assets/imgs/base`))
      .set('@theme',resolve(`src/assets/theme/${SITE}`))
       .set('@langStyle',resolve(`src/assets/lang/${SITE}`))
       .set('@siteStyle',resolve(`src/assets/styles/${SITE}`))
      .set('@locales',resolve(`src/locales`))
      .set('router',resolve(`src/router/${SITE}`))
      .set('components',resolve('src/components'))
      .set('site',resolve(`src/sites/${SITE}/${TEMP}`))
